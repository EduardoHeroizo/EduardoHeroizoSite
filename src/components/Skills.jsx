...
p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-[9px_9px_0px_#000]">      
    <h1 className="font-comic text-3xl font-bold mb-6">
      ...
      <div className="grid grid-cols-6 gap-x-4 gap-y-5 items-center justify-items-center w-full">
        {/* Java */}
        <div className="relative group w-16 h-16 flex items-center justify-center">
          <img
            src={javaIcon}
            alt="Java"
            className="w-[76px] h-[76px] transition-transform duration-300 hover:scale-110"
          />
        ...
        <div className="relative group w-16 h-16 flex items-center justify-center">
          <img
            src={sqlIcon}
            alt="SQL"
            className="w-14 h-14 transition-transform ml-3 duration-300 hover:scale-110"
          />
        ...
        {/* Linux */}
        <div className="relative group w-22 h-16 flex items-center justify-center">
          <img
            src={linuxIcon}
            alt="Linux"
            className="w-22 h-20 transition-transform duration-300 hover:scale-110"
          />
