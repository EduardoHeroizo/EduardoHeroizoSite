function Experience() {
  return (
    <div className="bg-white rounded-xl border border-black shadow-[6px_6px_0px_#000] p-6 w-[560px] flex flex-col items-center transition-transform duration-300 hover:-translate-y-1 hover:shadow-[9px_9px_0px_#000]">
      ...
      <div className="w-full max-h-[600px] overflow-y-auto pr-2 flex flex-col gap-4">
        {/* Experience 1 */}
        <div className="bg-yellow-100 border-2 border-black rounded-xl p-4">
          ...
          <p className="font-comic text-sm text-black/60 mb-3">
            Federal University of Campina Grande • May 2025 — Present
          </p>

          <ul className="font-comic text-black/80 list-disc list-inside space-y-1 mb-4">
          ...
          <h3 className="font-comic text-md text-black mb-2">
            What I learned
          </h3>

          <div className="flex flex-wrap gap-2">
            <span className="font-comic text-sm bg-blue-50 border border-black rounded-md px-3 py-1">
              Formal Logic
            </span>
